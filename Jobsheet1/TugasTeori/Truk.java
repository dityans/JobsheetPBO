...
public class Truk {
    ...
    public Truk(String merk, String warna, int tahunProduksi, String jenisBahanBakar, String platNomor, double rasioBBM) {
        this.merk = merk;
        this.warna = warna;
    ...
    public double estimasiBBM(double jarakKM) {
        ...
        if (jenisBahanBakar.equalsIgnoreCase("Solar")) {
